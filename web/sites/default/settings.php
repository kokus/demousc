 ...
 * @endcode
 */
$settings['hash_salt'] = 'qLKmIlGXMomyLg7a0GsRBd0BevAjTOmEv06evCAxTZ6j3fHN9n0eaGvI4us6YMBt1p9-Jgi2kA';
...
// Redis settings.
if (getenv('DRUPAL_REDIS_HOST') && getenv('DRUPAL_REDIS_PORT') && file_exists($app_root . '/' . $site_path . '/settings.redis.php')) {
